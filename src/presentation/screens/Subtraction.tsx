...
const OP = 'sub'; // <-- Ajusta al valor que espera tu backend: 'sub', 'subtract', etc.
...
export const Subtraction = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Resta</Text>
      ...
      {problem ? (
        <View style={styles.card}>
          ...
          <TextInput
            style={styles.input}
            // En iOS, 'numeric' no muestra el signo '-', por eso usamos 'numbers-and-punctuation'
