...
export const Division = () => {
  ...
  const mascotMessage = (() => {
    if (!totalSolved)
      return '¡Bienvenido! Dividir es repartir en partes iguales 😊';
    if (lastCorrect === true) {
      if (streak >= 3)
        return '🔥 ¡Racha increíble! Cada vez divides con más seguridad.';
      return '✅ ¡Buen trabajo! Sigamos con más ejercicios.';
    }
    if (lastCorrect === false) {
      return 'No pasa nada si te equivocas, piensa: ¿en cuántos grupos iguales se puede repartir? 💛';
    }
    return 'Sigue practicando, cada intento te hace más fuerte con las divisiones ✨';
  })();
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.banner}>
        <View>
          <Text style={styles.appTitle}>División</Text>
        </View>
      ...
      {problem ? (
        <>
          ...
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Resuelve la siguiente división</Text>
            ...
            {showHint && (
              <View style={styles.hintBox}>
                <Text style={styles.hintText}>
                  ...
                  {problem.a} ÷ {problem.b} significa: si tienes {problem.a} cosas y
                  las repartes en {problem.b} grupos iguales,{"\n"}
          ...
          <View style={styles.bottomPanel}>
            ...
            <Text style={styles.bottomPanelHint}>
              Cuando llegues a tu meta, ¡desbloquearás nuevos retos de división! 🎉
            </Text>
          </View>
        </>
      ) : (
