...
const OP = 'mul'; // Ajusta si tu backend usa otro nombre
...
export const Multiplication = () => {
  ...
  // nivel + stats (igual que en Resta)
  ...
  const mascotMessage = (() => {
    if (!totalSolved)
      return '¡Bienvenido! Multiplicar es sumar varias veces el mismo número';
    if (lastCorrect === true) {
      if (streak >= 3)
        return '🔥 ¡Racha increíble! Tus tablas van muy bien.';
      return '✅ Buen trabajo, sigamos practicando.';
    }
    if (lastCorrect === false) {
      return 'Piensa en grupos: si tienes varios grupos iguales, ¿cuántos hay en total? 💛';
    }
    return 'Cada intento te acerca a dominar las multiplicaciones ✨';
  })();
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.banner}>
        <View>
          <Text style={styles.appTitle}>Multiplicación</Text>
        </View>
      ...
      {problem ? (
        <>
          ...
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Resuelve la siguiente multiplicación</Text>
            ...
            {showHint && (
              <View style={styles.hintBox}>
                <Text style={styles.hintText}>
                  ...
                  {problem.a} × {problem.b} significa {problem.a} + {problem.a} + ... ({problem.b} veces).{"\n"}
                  También puedes pensar en {problem.b} grupos de {problem.a} objetos.
                </Text>
              </View>
            )}
          ...
          <View style={styles.bottomPanel}>
            ...
            <Text style={styles.bottomPanelHint}>
              Cuando llegues a tu meta, ¡desbloquearás nuevos retos de multiplicación! 🎉
            </Text>
          </View>
        </>
      ) : (
